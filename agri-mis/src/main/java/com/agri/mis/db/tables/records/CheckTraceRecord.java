...
public class CheckTraceRecord extends UpdatableRecordImpl<CheckTraceRecord> implements Record9<Long, String, Long, Long, Integer, Long, LocalDateTime, String, String> {
    ...
    @Override
    public Row9<Long, String, Long, Long, Integer, Long, LocalDateTime, String, String> valuesRow() {
    ...
    @Override
    public CheckTraceRecord values(Long value1, String value2, Long value3, Long value4, Integer value5, Long value6, LocalDateTime value7, String value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CheckTraceRecord(Long id, String entityName, Long entityId, Long userId, Integer status, Long corpId, LocalDateTime createdAt, String title, String description) {
        super(CheckTrace.CHECK_TRACE);

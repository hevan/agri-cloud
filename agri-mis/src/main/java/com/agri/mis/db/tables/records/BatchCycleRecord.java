...
public class BatchCycleRecord extends UpdatableRecordImpl<BatchCycleRecord> implements Record15<Long, String, String, String, Integer, LocalDate, LocalDate, Long, Short, Long, Double, Long, String, OffsetDateTime, Short> {
     ...
     */
    public BatchCycleRecord setCreatedAt(OffsetDateTime value) {
        set(13, value);
        return this;
    }
    ...
    @Override
    public Row15<Long, String, String, String, Integer, LocalDate, LocalDate, Long, Short, Long, Double, Long, String, OffsetDateTime, Short> valuesRow() {
    ...
    @Override
    public BatchCycleRecord value14(OffsetDateTime value) {
        setCreatedAt(value);
        return this;
    }
    ...
    @Override
    public BatchCycleRecord values(Long value1, String value2, String value3, String value4, Integer value5, LocalDate value6, LocalDate value7, Long value8, Short value9, Long value10, Double value11, Long value12, String value13, OffsetDateTime value14, Short value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BatchCycleRecord(Long id, String name, String description, String imageUrl, Integer days, LocalDate startAt, LocalDate endAt, Long batchId, Short status, Long parentId, Double progress, Long createdUserId, String createdBy, OffsetDateTime createdAt, Short cycleType) {
        super(BatchCycle.BATCH_CYCLE);

...
public class Keys {
    ...
    public static final UniqueKey<CmsVideoRecord> CMS_VIDEO_PKEY = Internal.createUniqueKey(CmsVideo.CMS_VIDEO, DSL.name("cms_video_pkey"), new TableField[] { CmsVideo.CMS_VIDEO.ID }, true);

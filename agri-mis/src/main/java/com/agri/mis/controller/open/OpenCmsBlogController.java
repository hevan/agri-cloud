...
@RestController
@Slf4j
@RequestMapping("/open/cmsBlog")
public class OpenCmsBlogController {
    ...
    public Mono<Page<CmsBlogInfo>> pageQuery(@RequestBody CmsBlog cmsBlog , @RequestParam("page") int page, @RequestParam("size") int size) {

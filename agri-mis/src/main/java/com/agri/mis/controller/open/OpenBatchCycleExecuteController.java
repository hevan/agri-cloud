...
@RestController
@Slf4j
@RequestMapping("/open/batch/cycle/execute")
public class OpenBatchCycleExecuteController {
    ...
    public Mono<Page<BatchCycleExecute>> pageQuery(@RequestParam("name") String name, @RequestParam("page") int page, @RequestParam("size") int size) {

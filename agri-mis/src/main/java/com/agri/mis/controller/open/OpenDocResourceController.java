...
@Slf4j
@AllArgsConstructor
@RequestMapping("/open/docResource")
public class OpenDocResourceController {
    ...
    public Mono<Page<DocResource>> pageQuery(DocResource docResource, @RequestParam("page") int page, @RequestParam("size") int size) {
